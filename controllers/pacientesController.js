...
class PacientesController{
    ...
    consultar(req, res) {
        try {
            db.query('SELECT * FROM tbl_paciente', (err, data) => {
                if (err) {
    ...
    ingresar(req, res) {
        try {
            ...
            // Inserción
            db.query('INSERT INTO tbl_paciente (idUsuario) VALUES(?);',
                [idUsuario],
                (err, rows) => {
                    if (err) {
    ...
    actualizar(req, res) {
        ...
        try {
            ...
            // Actualización
            db.query('UPDATE tbl_paciente SET idUsuario = ? WHERE idPaciente = ?',
                [idUsuario, id],
                (err, rows) => {
                    if (err) {
